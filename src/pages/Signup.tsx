...
const Signup: React.FC = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      // Check if the backend expects a single "images" field with multiple files
      // or separate fields for each image
      if (photo1) formData.append("images", photo1);
      if (photo2) formData.append("images", photo2);
